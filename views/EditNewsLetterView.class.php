...
HTML;
			...
			<div><span style="color:red"> Newsletter supports macros in the text and currenly supported macro is [NAME].<br/> 
				Future upgrade will support the following macro's: [NAME], [CURRENT_DATE], [UNREGISTER_LINK]<br/>
			</div>
