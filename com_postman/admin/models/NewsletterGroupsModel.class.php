...
final class NewsletterGroupsModel extends ProximityModel {

	static $EMPTY_ARRAY = array();
	public function __construct() {
		parent::__construct();
	}
	public function create($name, $description, $public) {
		$db = JFactory::getDbo();
	...
	public function update($newsgroupId, $name, $description, $public) {
		$db = JFactory::getDbo();
		$query = $db->getQuery(true);
		...
		$query->set($db->quoteName('public').' = '.$db->quote($public));
	...
	public function findByName($name) {
		...
		if ($record == null) {
			$record = NewsletterGroupsModel::$EMPTY_ARRAY;
		}
	...
	public function getSubscribersByGroupIdBlockWise($groupId, $offset = null, $limit = null) {
		...
		if ($records == null) {
			$records = NewsletterGroupsModel::$EMPTY_ARRAY;
		}
	...
	public function getSubscribersByGroupNameBlockWise($name, $offset = null, $limit = null) {
		...
		$query->join('LEFT', NEWSGROUP_TABLE . ' ng ');
	...
	public function updateGroupSubscribers($groupId, $subscribers) {
		...
		foreach($usrsExisting as $usr) {
			if (!in_array($usr->subscriber_id, $subscribers)) {
