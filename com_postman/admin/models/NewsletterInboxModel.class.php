...
final class NewsletterInboxModel extends ProximityModel {
	...
	public function subscribe($ticket, $email) {
		$db = JFactory::getDbo();
	...
	public function unsubscribe($ticketid, $email) {
		$db = JFactory::getDbo();
		$query = $db->getQuery(true);
	...
	public function findTicketId($newsgroupId) {
		$db = JFactory::getDbo();
		$query = $db->getQuery(true);
		$query->select("*");
