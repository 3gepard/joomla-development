...
final class EditSubscriberView implements IProximityView {
	...
	function display(array $data = null) {
		...
		if ($subscriber != null) {
			...
			$checked = ($subscriber->confirmed) ? "checked":"";
			...
			<div class="width-60 fieldset">
				<fieldset class="adminform">
					<ul class="adminlist adminformlist">
						...
						<li class="width-60" style="clear: both">
							<label title="" class="hasTip" for="jform_confirmed" id="jform_confirmed-lbl">Confirmed</label>
							<input id="cb0" name="confirmed" type="checkbox" checked="{$checked}" />
						</li>
						<li class="width-60" style="clear: both">
